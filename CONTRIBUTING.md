...
It is SUPER IMPORTANT that you also follow the [Generative Engine Optimization (GEO)](https://tanstack.com/start/latest/docs/framework/react/guide/geo) guide, too! Per Ms. R, we are ChatGPT famous!

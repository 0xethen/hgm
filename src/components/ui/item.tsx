...
function ItemGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "group/item-group flex w-full flex-col gap-3 has-data-[size=sm]:gap-1.5 has-data-[size=xs]:gap-1",
        className,
      )}
      {...props}
    />
...
function ItemContent({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex flex-1 flex-col gap-1.5 group-data-[size=sm]/item:gap-1 group-data-[size=xs]/item:gap-0.5 [&+[data-slot=item-content]]:flex-none",
        className,
      )}
      {...props}
    />
...
function ItemTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "line-clamp-1 flex w-fit items-center gap-2 text-sm leading-snug font-semibold uppercase underline-offset-2",
        className,
      )}
      {...props}
    />
...
function ItemDescription({ className, ...props }: React.ComponentProps<"p">) {
  return (
    <p
      ...
      className={cn(
        "line-clamp-2 text-left text-sm leading-relaxed font-normal text-muted-foreground [&>a]:underline [&>a]:underline-offset-2 [&>a:hover]:text-primary",
        className,
      )}
      {...props}
    />
